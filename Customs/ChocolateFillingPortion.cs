...
{
    class ChocolateFillingPortion : CustomItem
    {
        public override string UniqueNameID => "ChocolateFillingPortion";
        public override GameObject Prefab => Mod.Milk.Prefab;         // Filler line until graphics are made
